...
A {pki_url_nice_label} is a set of roles, policies, hardware, software and procedures needed to create, manage, distribute, use, store and revoke {pub_key_cert_nice_label}s and manage {pub_key_crypto_url_nice_label}. Diagram below shows simplified architecture for complex {pki_url_nice_label} solution.
