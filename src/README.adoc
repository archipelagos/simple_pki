...
:client_server_url_nice_label: https://en.wikipedia.org/wiki/Client%E2%80%93server_model[Client–server model]
...
{server_url_nice_label} according to {client_server_url_nice_label}.
...
{client_url_nice_label} according to {client_server_url_nice_label}.
